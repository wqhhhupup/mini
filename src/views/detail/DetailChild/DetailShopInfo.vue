<template>
    <div class="shop-info">
      ...
      <div class="shop-middle">
        ...
        <div class="shop-inner-left">
          <div class="sell">{{shopInfo.cSells|sellFomat}}</div>
          <div class="sell-text">总销量</div>
        </div>
          <div>
            <div class="Goods">{{shopInfo.cGoods}}</div>
            <div class="goods-text">全部宝贝</div>
          </div>
        </div>
        <div class="shop-middle-right shop-middle-item">
          <table>
            <tr :key="index" v-for="(item, index) in shopInfo.score">
              <td>{{ item.name }}</td>
